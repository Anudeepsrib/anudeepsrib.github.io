...
export async function generateMetadata({
  ...
  return pageMetadata({
    ...
    description: note.description || `Technical field note: ${note.title}`,
    path: `/notes/${slug}`,
        ...
        <article className="container mx-auto max-w-4xl px-6 py-20">
          ...
          <ScrollReveal delay={0.1}>
            <header className="mb-12">
              ...
              <div className="flex flex-wrap items-center gap-x-3 gap-y-2 text-sm text-[var(--text-2)]">
                {note.category && (
          ...
          <ScrollReveal delay={0.3}>
            <div className="mt-16 border-t border-[var(--border)] pt-8">
              <Link
                href="/blog"
                className="hover:bg-[var(--accent-2)]/90 inline-flex items-center gap-2 rounded-lg bg-[var(--accent-2)] px-4 py-2 text-[var(--bg)] transition-colors"
              >
                <ArrowLeft size={16} />
                Back to Field Notes
              </Link>
