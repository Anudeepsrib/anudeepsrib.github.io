  ...
  return (
    <motion.div
      className={cn(
        ...
        interactive &&
          "cursor-pointer transition-colors duration-200 hover:border-[rgba(125,211,252,0.28)] hover:bg-[var(--surface-raised)] hover:shadow-glow",
        featured &&
          "border-[rgba(125,211,252,0.24)] bg-[rgba(125,211,252,0.055)]",
        className,
      )}
