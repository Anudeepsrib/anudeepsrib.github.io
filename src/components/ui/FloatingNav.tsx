    ...
    return (
        <>
            ...
            >
                ...
                >
                    <Link href="/" className="flex items-center gap-2.5 rounded-md outline-none transition-opacity hover:opacity-80">
                        <Image src="/assets/logo.png" alt="" width={28} height={28} className="h-7 w-7 rounded-md" />
                        <span className="text-sm font-semibold text-[var(--text)]">anudeep</span>
                    </Link>
